...
public class AboutActivity extends Activity {
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			InputStreamReader is = new InputStreamReader(this.getResources().openRawResource(R.raw.about));
			...
			final PackageInfo packageInfo = getPackageManager().getPackageInfo(getClass().getPackage().getName(), 0);
