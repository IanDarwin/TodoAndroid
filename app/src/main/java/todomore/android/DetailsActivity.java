...
public class DetailsActivity extends Activity {
	...
	public void onCreate(Bundle saved) {
		...
		Button markAsDoneButton = (Button) findViewById(R.id.markAsDoneButton);
        ...
        ((Button) findViewById(R.id.cancelDetailsButton)).setOnClickListener(v -> finish());

		((Button) findViewById(R.id.deleteButton)).setOnClickListener(v -> deleteCurrent());
	}
